...
(function () {
  ...
  function initStepForm(form) {
    const prevBtn = form.querySelector(".js-form-btn-prev");
    const nextBtn = form.querySelector(".js-form-btn-next");
    const submitBtn = form.querySelector(".js-form-btn-submit");
